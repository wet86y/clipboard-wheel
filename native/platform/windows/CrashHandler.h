...
[[nodiscard]] bool crash_write_hang_dump(HANDLE process, DWORD process_id,
...
inline bool crash_write_hang_dump(HANDLE, DWORD, DWORD, std::wstring_view) noexcept { return false; }
