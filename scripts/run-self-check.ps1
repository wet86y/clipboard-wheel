...
$checks = @(
    ...
    @{ Name = "release verifies the embedded replacement stub"; Passed = $releaseConfigSource -match '"releaseVerificationArguments"' -and $releaseConfigSource -match '"--verify-release"' -and $appSource -match 'VerifyReleaseBundle' -and $appSource -match 'UpdaterStubResourceName' -and $releaseScript -match 'Invoke-ReleaseExecutableVerification' -and $sharedReleaseRules -match 'Invoke-ReleaseExecutableVerification' },
